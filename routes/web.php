...
// Login
Route::get('/login', [AuthController::class, 'login'])->name('login')->middleware('verified');
...
//middleware untuk role admin
    ...
    Route::middleware(['web', 'auth', 'verified','role:admin', ])->group(function () {
        ...
        Route::get('/media/cari', [MediaController::class, 'cari']);

    Route::get('/forum', [profileController::class, 'index']);
...
// untuk user
    ...
    Route::get('/perpustakaan', [MediaController::class, 'perpustakaan']);
...
// untuk user
Route::middleware(['auth' ,'verified','role:users,admin','web',])->group(function () {
     Route::get('/forum/question', [tampilController::class, 'question']);
    Route::get('/perpustakaan', [MediaController::class, 'perpustakaan']);
    Route::get('/forum', [tampilController::class, 'index']);
    Route::get('/perpustakaan/search', [MediaController::class, 'search']);
    Route::get('/forum/create', [ForumController::class, 'create']);
